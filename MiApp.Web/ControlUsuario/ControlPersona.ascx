...
<dx:ASPxCallbackPanel ID="AcpControlPersona" ClientInstanceName="AcpControlPersona" runat="server" OnCallback="AcpControlPersona_Callback">
    <PanelCollection>
        <dx:PanelContent runat="server">
            <dx:ASPxPopupControl ID="ApcControlPersona" ClientInstanceName="ApcControlPersona" runat="server" Width="500px" HeaderText="Personas"
                PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" AutoUpdatePosition="true" Model="true" CloseAction="CloseButton">
                <ContentCollection>
                    <dx:PopupControlContentControl runat="server">
                        <dx:ASPxGridView ID="AgvControlPersona" runat="server" AutoGenerateColumns="false" DataSourceID="OdsControlPersona" width="100%">
                            <ClientSideEvents RowDblClick="funtion(s, e) { DobleClickFila(s, e); }"/>
...
<asp:ObjectDataSource runat="server" ID="OdsControlPersona" SelectMethod="Listar" TypeName="MiApp.Bll.PersonaBll">
    <SelectParameters>
