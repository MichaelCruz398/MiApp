...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
        ...
        <PanelCollection>
            <dx:PanelContent runat="server">
                <dx:ASPxTreeList  ID="ASPxTreeList1" runat="server" AutoGenerateColumns="False" 
                    DataSourceID="OdsArbol" KeyFieldName="Codigo" ParentFieldName="Padre">

                    <Columns>
                        <dx:TreeListTextColumn FieldName="Nombre" AutoFilterCondition="Default" ShowInFilterControl="Default" VisibleIndex="0"></dx:TreeListTextColumn>
                        <dx:TreeListTextColumn FieldName="Codigo" AutoFilterCondition="Default" ShowInFilterControl="Default" VisibleIndex="1"></dx:TreeListTextColumn>
    ...
    <asp:ObjectDataSource ID="OdsArbol" runat="server" SelectMethod="Listar" TypeName="MiApp.Bll.ArbolBll">
        <SelectParameters>
