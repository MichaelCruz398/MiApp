<%@ Page Title="Tarjeta" Language="C#" MasterPageFile="~/Pagina/Inicio/Master.Master" AutoEventWireup="true" CodeBehind="Tarjeta.aspx.cs" Inherits="MiApp.Web.Pagina.Varios.Tarjeta" %>
    ...
    <dx:ASPxCallbackPanel ID="AcpTarjeta" runat="server" Width="100%">
        <PanelCollection>
            <dx:PanelContent runat="server">
                <dx:ASPxCardView ID="AcwTarjeta" runat="server" Width="100%" AutoGenerateColumns="False" Style-Table-BackColor="#f7f7f7" Border-BorderWidth="0" KeyFieldName="Codigo"
                    OnSelectionChanged="AcwTarjeta_SelectionChanged" DataSourceID="OdsModulo">
                    ...
                    <Columns>
                        ...
                        <dx:CardViewImageColumn FieldName="Icono" >
                            <PropertiesImage ImageWidth="200px"></PropertiesImage>
